#!/usr/bin/env python3
"""
ASD Complete System - ENHANCED VERSION (FIXED)
...
@app.route('/')
def index():
    return render_template_string(HTML_TEMPLATE, games=GAMES_LIST, icons=ICONS)
...
def chat():
    ...
    return jsonify({'response': "I'm here to help! Ask me about autism signs, therapies, communication, sensory needs, meltdowns, routines, or early intervention."})
...
if __name__ == '__main__':
    print("\n" + "="*50)
    print("🧩 ASD ENHANCED DASHBOARD (FIXED)")
    print("="*50)
